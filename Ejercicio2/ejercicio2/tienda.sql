...
insert into EMPLEADOS values (410, 122, 660, '1996-10-30', '2014-07-25', 1175, null, 0, 'MUãOZ, AZUCENA');
...
ADD FOREIGN KEY (Centro) REFERENCES CENTROS(Numero),
ADD FOREIGN KEY (Depto_jefe) REFERENCES DEPARTAMENTOS(Numero),
ADD FOREIGN KEY (Director) REFERENCES EMPLEADOS(Cod);
